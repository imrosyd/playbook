...
export default function LineChart({ state, width = 640, height = 400 }: LineChartProps) {
    ...
    useEffect(() => {
        ...
        g.selectAll('.dot')
            ...
            .attr('opacity', 0)
            .transition()
            .delay((_, i) => (i / processedData.length) * 400)
            .duration(200)
            .attr('opacity', 1);
        ...
        if (state.params.labelMode !== 'none') {
            ...
            labels.transition()
                .delay((_, i) => (i / processedData.length) * 400 + 100)
                .duration(400)
                .ease(d3.easeCubicOut)
                .attr('opacity', 1);
        }
