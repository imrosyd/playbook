...
const crossRefs = (lang: any) => [
    { sectionId: 'lab', slug: 'axis-scale', label: t(lang, 's4.narrativeScale.crossRefs.0.label') },
];
...
function ScaleDomainNarrativeDemo() {
    ...
    return (
        <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
            <h3 className="text-[14px] font-bold text-stone-800 uppercase tracking-wide mb-6">{t(lang, 's4.narrativeScale.domainDemo.title')}</h3>
            <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1 w-full bg-stone-50 border border-stone-100 rounded-xl p-6 relative min-h-[250px] flex justify-center">
                    <div className="absolute top-4 right-4">
                        <div className="bg-stone-200 p-1 rounded-lg flex gap-1">
                            <button onClick={() => setDomain('-2to2')} className={`px-3 py-1 text-[10px] font-bold rounded shadow-sm transition-all ${domain === '-2to2' ? 'bg-white text-stone-800' : 'text-stone-500 hover:text-stone-700'}`}>{t(lang, 's4.narrativeScale.domainDemo.btnDomain2')}</button>
                            <button onClick={() => setDomain('-5to5')} className={`px-3 py-1 text-[10px] font-bold rounded shadow-sm transition-all ${domain === '-5to5' ? 'bg-white text-stone-800' : 'text-stone-500 hover:text-stone-700'}`}>{t(lang, 's4.narrativeScale.domainDemo.btnDomain5')}</button>
                        </div>
                    </div>
                ...
                <div className="flex-1 flex flex-col justify-center">
                    <p className="text-[14px] text-stone-600 bg-white border border-stone-200 p-5 rounded-xl shadow-sm leading-relaxed">
                        {domain === '-5to5' ? t(lang, 's4.narrativeScale.domainDemo.desc5') : t(lang, 's4.narrativeScale.domainDemo.desc2')}
                    </p>
                </div>
            </div>
        </div>
...
function EconomistStyleDemo() {
    ...
    return (
        <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
            <h3 className="text-[14px] font-bold text-stone-800 uppercase tracking-wide mb-6">{t(lang, 's4.narrativeScale.economistDemo.title')}</h3>
            <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1 w-full bg-stone-50 border border-stone-100 rounded-xl p-6 relative min-h-[250px] flex flex-col justify-center">
                    <h4 className="text-[12px] font-bold text-stone-700 uppercase tracking-widest border-b border-stone-300 pb-1 mb-4 flex justify-between">
                        <span>{t(lang, 's4.narrativeScale.economistDemo.chartTitle')}</span>
                        <span className="text-stone-400 font-normal normal-case">{t(lang, 's4.narrativeScale.economistDemo.chartSubtitle')}</span>
                    </h4>
                    ...
                    <svg viewBox="0 0 100 50" className="w-full h-auto overflow-visible">
                        ...
                        <text x="60" y="-1.5" fontSize="3.5" fill="#fff" textAnchor="middle">{t(lang, 's4.narrativeScale.economistDemo.todayLabel')}</text>
                ...
                <div className="flex-1 flex flex-col justify-center">
                    <p className="text-[14px] text-stone-600 bg-white border border-stone-200 p-5 rounded-xl shadow-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: t(lang, 's4.narrativeScale.economistDemo.desc') }} />
                </div>
            </div>
        </div>
    );
...
function ContextualAnnotationsDemo() {
    ...
    return (
        <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
            <h3 className="text-[14px] font-bold text-stone-800 uppercase tracking-wide mb-6">{t(lang, 's4.narrativeScale.annotationsDemo.title')}</h3>
            <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1 w-full bg-stone-50 border border-stone-100 rounded-xl p-6 relative min-h-[250px] flex justify-center items-end">
                    <svg viewBox="0 0 100 80" className="w-[90%] max-w-[300px] h-auto overflow-visible">
                        ...
                        {/* X-axis labels */}
                        <text x="14" y="70" fontSize="3" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.0')}</text>
                        <text x="26" y="70" fontSize="3" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.1')}</text>
                        <text x="38" y="70" fontSize="3" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.2')}</text>
                        <text x="50" y="70" fontSize="3" fill="#ef4444" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.3')}</text>
                        <text x="62" y="70" fontSize="3" fill="#ef4444" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.4')}</text>
                        <text x="74" y="70" fontSize="3" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.5')}</text>
                        <text x="86" y="70" fontSize="3" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.days.6')}</text>
                        ...
                        {/* Annotation Text */}
                        <text x="56" y="14" fontSize="4" fill="#b91c1c" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.annotationText1')}</text>
                        <text x="56" y="27" fontSize="3" fill="#ef4444" textAnchor="middle">{t(lang, 's4.narrativeScale.annotationsDemo.annotationText2')}</text>

                    </svg>
                </div>
                <div className="flex-1 flex flex-col justify-center">
                    <p className="text-[14px] text-stone-600 bg-white border border-stone-200 p-5 rounded-xl shadow-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: t(lang, 's4.narrativeScale.annotationsDemo.desc') }} />
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-[14px] font-bold text-stone-800 uppercase tracking-wide">{t(lang, 's4.narrativeScale.aestheticDemo.title')}</h3>
                <button
                ...
                >
                    {is3D ? t(lang, 's4.narrativeScale.aestheticDemo.btnFlatten') : t(lang, 's4.narrativeScale.aestheticDemo.btn3D')}
                </button>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <svg viewBox="0 0 100 80" className="w-[80%] max-w-[250px] h-auto overflow-visible">
                        {is3D ? (
                            <g>
                                ...
                                <text x="25" y="76" fontSize="4" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.aestheticDemo.labels.q1')}</text>
                                <text x="55" y="66" fontSize="4" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.aestheticDemo.labels.q2')}</text>
                            </g>
                        ) : (
                            <g>
                                ...
                                <text x="92" y="21" fontSize="4" fill="#d97706">{t(lang, 's4.narrativeScale.aestheticDemo.labels.quota')}</text>
                                ...
                                <text x="32.5" y="75" fontSize="4" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.aestheticDemo.labels.q1')}</text>
                                <text x="62.5" y="75" fontSize="4" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.aestheticDemo.labels.q2')}</text>
                            </g>
                        )}
                    </svg>
                </div>
                <div className="flex-1 flex flex-col justify-center">
                    <p className="text-[14px] text-stone-600 bg-white border border-stone-200 p-5 rounded-xl shadow-sm leading-relaxed">
                        {is3D ? t(lang, 's4.narrativeScale.aestheticDemo.desc3D') : t(lang, 's4.narrativeScale.aestheticDemo.desc2D')}
                    </p>
                </div>
            </div>
        </div>
...
function SlopegraphLimitationsDemo() {
    ...
    return (
        <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-[14px] font-bold text-stone-800 uppercase tracking-wide">{t(lang, 's4.narrativeScale.slopegraphDemo.title')}</h3>
                <button
                    onClick={() => setIsFixed(!isFixed)}
                    className="px-4 py-2 rounded-lg text-xs font-bold transition-all bg-stone-100 text-stone-800 border border-stone-200 shadow-sm hover:bg-stone-200"
                >
                    {isFixed ? t(lang, 's4.narrativeScale.slopegraphDemo.btnRevert') : t(lang, 's4.narrativeScale.slopegraphDemo.btnFix')}
                </button>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1 w-full bg-stone-50 border border-stone-100 rounded-xl p-6 relative min-h-[250px] flex justify-center">
                    <svg viewBox="0 0 100 80" className="w-[90%] max-w-[300px] h-auto overflow-visible">
                        {/* Title & Axes */}
                        <text x="50" y="5" fontSize="5" fill="#334155" textAnchor="middle" fontWeight="bold">{t(lang, 's4.narrativeScale.slopegraphDemo.chartTitle')}</text>
                        <line x1="20" x2="20" y1="15" y2="75" stroke="#cbd5e1" strokeWidth={0.5} />
                        <line x1="80" x2="80" y1="15" y2="75" stroke="#cbd5e1" strokeWidth={0.5} />

                        <text x="20" y="12" fontSize="4" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.slopegraphDemo.labels.year23')}</text>
                        <text x="80" y="12" fontSize="4" fill="#64748b" textAnchor="middle">{t(lang, 's4.narrativeScale.slopegraphDemo.labels.year24')}</text>
                ...
                <div className="flex-1 flex flex-col justify-center">
                    <p className="text-[14px] text-stone-600 bg-white border border-stone-200 p-5 rounded-xl shadow-sm leading-relaxed">
                        {t(lang, 's4.narrativeScale.slopegraphDemo.desc')}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-[15px] text-stone-600 leading-relaxed mb-4">
                        {t(lang, 's4.narrativeScale.intro1')}
                    </p>
                </div>
