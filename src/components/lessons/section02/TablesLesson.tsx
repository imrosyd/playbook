        ...
        <LessonPage crossRefs={crossRefs}>
            <div className="space-y-8">
                <p className="text-[15px] text-stone-600 leading-relaxed">
                    In the push to make everything visual, one of the most powerful communication tools gets forgotten: the humble table. A well-formatted table beats a complex chart in several critical situations. Knowing when to choose a table over a chart is a mark of a genuinely skilled data communicator.
                </p>
